...
import { Undo2, HandCoins, ArrowRightLeft } from "lucide-react"
  ...
  const hero = {
    ...
    description:
      "We want you to love your purchase. If you are not satisfied, our Return Policy makes it simple to exchange or return items under clear and fair terms.",
  }

  const eligibilityItems = [
    "The item must be unused and in the same condition as received.",
    "Refund & return policy: Offer product not available in this criteria",
    "It must be in the original packaging with all tags intact.",
    "Returns must be initiated within 5–10 days of delivery.",
    // "Certain products such as intimate wear, sale items, or personalized goods are non-returnable.",
  ]
  ...
  const returnPolicies = [
    {
      ...
      description:
        "To initiate a return, please contact our support team with your order number. We will provide instructions and a return shipping label if applicable.",
    },
    {
      icon: HandCoins,
      title: "Refunds",
      description:
        "Approved refunds will be processed to your original payment method within 5–10 business days. The time for the refund to appear may vary depending on your bank or payment provider.",
    },
    {
      icon: ArrowRightLeft,
      title: "Exchanges",
      description:
        "We replace items only if they are defective, damaged, or the wrong size/color. Please specify your preferred replacement item when contacting support.",
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="relative flex items-center justify-center overflow-hidden bg-[#3A9E75] text-white py-14">
        ...
        >
          <Undo2 className="mx-auto mb-4" size={60} />
      ...
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <motion.div variants={fadeInVariants} className="relative overflow-hidden rounded-lg shadow-xl aspect-video group">
            <img
      ...
      >
        <motion.div
          variants={fadeInVariants}
          className="mx-auto max-w-[1640px] px-3 sm:px-4 md:px-16 text-center"
        >

...
export default function NestedCategoryGridCard({ item }) {
  ...
  return (
    <div className="relative h-[350px] xs:h-[380px] sm:h-[450px] md:h-[350px] lg:h-[350px] xl:h-[400px] 2xl:h-[490px] w-full overflow-hidden rounded-md group cursor-pointer">
      ...
      <div className="relative z-20 h-full flex items-center  px-4">
        ...
        <div className=' absolute bottom-8 left-4 right-4 text-white  w-full'>
          <h2 className="text-xl md:text-2xl font-bold mb-6 space-grotesk">{item?.name?.name}</h2>
          <div className="  flex flex-wrap gap-3 ">
            ...
            {item?.categories.map((cat, id) => (
              ...
              key={id}
                ...
                className="border border-white text-white px-2 py-2 md:px-3 md:py-2 text-xs md:text-sm
